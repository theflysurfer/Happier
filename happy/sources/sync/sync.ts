...
import type { ImageAttachment } from './typesMessage';
...
class Sync {
    ...
    async sendMessage(sessionId: string, text: string, displayText?: string, images?: ImageAttachment[]) {
        ...
        if (images && images.length > 0) {
            // Claude multimodal format: array of content blocks
