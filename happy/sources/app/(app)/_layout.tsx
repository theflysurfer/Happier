...
export default function RootLayout() {
    ...
    return (
        ...
        >
            ...
            />
            <Stack.Screen
                name="session/[id]/file-manager"
                options={{
                    headerShown: true,
                    headerTitle: t('fileManager.title'),
                    headerBackTitle: t('common.back'),
                }}
            />
            <Stack.Screen
                name="session/[id]/markdown-preview"
                options={{
                    headerShown: true,
                    headerTitle: t('markdownPreview.title'),
                    headerBackTitle: t('common.back'),
                }}
            />
            <Stack.Screen
            ...
            <Stack.Screen
                ...
                options={{
                    headerShown: true,
                    headerTitle: t('annotations.title'),
                    headerBackTitle: t('common.back'),
                }}
            />
            <Stack.Screen
