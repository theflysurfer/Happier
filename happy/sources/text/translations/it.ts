...
export const it: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        reactivateSessionSubtitle: 'Avvia una nuova sessione nella stessa directory',
        reactivateSessionConfirm: 'Avviare una nuova sessione nella stessa directory sulla stessa macchina?',
        failedToReactivateSession: 'Impossibile riattivare la sessione',
        machineOffline: 'La macchina è offline',
        exportMarkdown: 'Esporta come Markdown',
        exportMarkdownSubtitle: 'Esporta la conversazione come file markdown',
        viewTranscript: 'Visualizza trascrizione',
        viewTranscriptSubtitle: 'Leggi la conversazione completa della sessione',
        markdownCopied: 'Markdown copiato negli appunti',
        markdownExported: 'Markdown esportato con successo',
        viewProjectSessions: 'Tutte le sessioni di questo progetto',
        viewProjectSessionsSubtitle: 'Visualizza tutte le conversazioni in questo repository',
        projectSessions: 'Sessioni del progetto',
        noProjectSessions: 'Nessuna sessione trovata per questo progetto',
        projectSessionsCount: ({ count }: { count: number }) => count === 1 ? '1 sessione' : `${count} sessioni`,
    ...
    editor: {
        ...
        conflictMessage: 'The file has been modified externally. Overwrite with your changes?',
        overwrite: 'Overwrite',
    ...
    annotations: {
        ...
        addTag: 'Add Tag',
        macro: 'MACRO',
        macroDescription: 'Cross-document impact',
        reviewTags: 'Review Tags',
        saveAnnotations: 'Save Annotations',
        savedCount: ({ count }: { count: number }) => `${count} annotation${count !== 1 ? 's' : ''} saved`,
        noAnnotations: 'No annotations yet',
        noAnnotationsHint: 'Long-press on text to add feedback',
        tagTodo: '@TODO',
        tagFix: '@FIX',
        tagVerify: '@VERIFY',
        tagOk: '@OK',
    ...
    memory: {
        ...
        systemMemory: 'Memoria di sistema',
        trend: 'Tendenza',
        trendStable: 'Stabile',
        trendIncreasing: 'In aumento',
        trendDecreasing: 'In diminuzione',
        trendUnknown: 'Monitoraggio...',
        restartConversation: 'Riavvia conversazione',
        restartConversationSubtitle: 'Termina questa sessione e ricomincia',
        restartConversationConfirm: "L'utilizzo della memoria è criticamente alto. Riavviare la conversazione in una nuova sessione?",
        memoryWarning: ({ usage }: { usage: string }) => `RAM ${usage}`,
        systemAvailable: ({ available, total }: { available: string; total: string }) => `${available} liberi su ${total}`,
    },
