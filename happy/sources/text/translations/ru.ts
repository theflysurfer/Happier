...
export const ru: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        reactivateSession: 'Перезапустить сессию',
        reactivateSessionSubtitle: 'Начать новую сессию в том же каталоге',
        reactivateSessionConfirm: 'Начать новую сессию в том же каталоге на той же машине?',
        failedToReactivateSession: 'Не удалось перезапустить сессию',
        machineOffline: 'Машина не в сети',
        exportMarkdown: 'Экспорт в Markdown',
        exportMarkdownSubtitle: 'Экспортировать разговор в формате markdown',
        viewTranscript: 'Просмотр стенограммы',
        viewTranscriptSubtitle: 'Читать полный диалог сессии',
        markdownCopied: 'Markdown скопирован в буфер обмена',
        markdownExported: 'Markdown успешно экспортирован',
        viewProjectSessions: 'Все сессии этого проекта',
        viewProjectSessionsSubtitle: 'Просмотреть все обсуждения в этом репозитории',
    ...
    memory: {
        ...
        trendIncreasing: 'Растёт',
        trendDecreasing: 'Снижается',
        trendUnknown: 'Мониторинг...',
        restartConversation: 'Перезапустить',
        restartConversationSubtitle: 'Завершить сессию и начать заново',
        restartConversationConfirm: 'Использование памяти критически высокое. Перезапустить в новой сессии?',
        memoryWarning: ({ usage }: { usage: string }) => `RAM ${usage}`,
        systemAvailable: ({ available, total }: { available: string; total: string }) => `${available} свободно из ${total}`,
    },
