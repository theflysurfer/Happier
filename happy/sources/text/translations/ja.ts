...
export const ja: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        reactivateSession: 'セッションを再起動',
        reactivateSessionSubtitle: '同じディレクトリで新しいセッションを開始',
        reactivateSessionConfirm: '同じマシンの同じディレクトリで新しいセッションを開始しますか？',
        failedToReactivateSession: 'セッションの再起動に失敗しました',
        machineOffline: 'マシンがオフラインです',
        exportMarkdown: 'Markdownとしてエクスポート',
        exportMarkdownSubtitle: '会話をmarkdownファイルとしてエクスポート',
        viewTranscript: 'トランスクリプトを表示',
        viewTranscriptSubtitle: 'セッションの全会話を読む',
        markdownCopied: 'Markdownがクリップボードにコピーされました',
        markdownExported: 'Markdownのエクスポートに成功しました',
        viewProjectSessions: 'このプロジェクトの全セッション',
        viewProjectSessionsSubtitle: 'このリポジトリの全ディスカッションを表示',
