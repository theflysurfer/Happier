...
export const pl: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        reactivateSession: 'Reaktywuj sesję',
        reactivateSessionSubtitle: 'Rozpocznij nową sesję w tym samym katalogu',
        reactivateSessionConfirm: 'Rozpocząć nową sesję w tym samym katalogu na tej samej maszynie?',
        failedToReactivateSession: 'Nie udało się reaktywować sesji',
        machineOffline: 'Maszyna jest offline',
        exportMarkdown: 'Eksportuj jako Markdown',
        exportMarkdownSubtitle: 'Eksportuj rozmowę jako plik markdown',
        viewTranscript: 'Wyświetl transkrypt',
        viewTranscriptSubtitle: 'Przeczytaj pełną rozmowę sesji',
        markdownCopied: 'Markdown skopiowany do schowka',
        markdownExported: 'Markdown wyeksportowany pomyślnie',
        viewProjectSessions: 'Wszystkie sesje tego projektu',
        viewProjectSessionsSubtitle: 'Zobacz wszystkie rozmowy w tym repozytorium',
    ...
    memory: {
        ...
        trendIncreasing: 'Rośnie',
        trendDecreasing: 'Maleje',
        trendUnknown: 'Monitorowanie...',
        restartConversation: 'Uruchom ponownie',
        restartConversationSubtitle: 'Zakończ sesję i zacznij od nowa',
        restartConversationConfirm: 'Zużycie pamięci jest krytycznie wysokie. Uruchomić ponownie w nowej sesji?',
        memoryWarning: ({ usage }: { usage: string }) => `RAM ${usage}`,
        systemAvailable: ({ available, total }: { available: string; total: string }) => `${available} wolne z ${total}`,
    },
