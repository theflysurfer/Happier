...
export const en = {
    ...
    sessionInfo: {
        ...
        reactivateSessionSubtitle: 'Start a new session in the same directory',
        reactivateSessionConfirm: 'Start a new session in the same directory on the same machine?',
        failedToReactivateSession: 'Failed to reactivate session',
        machineOffline: 'Machine is offline',
        exportMarkdown: 'Export as Markdown',
        exportMarkdownSubtitle: 'Export conversation as a markdown file',
        viewTranscript: 'View Transcript',
        viewTranscriptSubtitle: 'Read the full session conversation',
        markdownCopied: 'Markdown copied to clipboard',
        markdownExported: 'Markdown exported successfully',
        viewProjectSessions: 'All Sessions for This Project',
        viewProjectSessionsSubtitle: 'View all discussions in this repository',
        projectSessions: 'Project Sessions',
        noProjectSessions: 'No sessions found for this project',
        projectSessionsCount: ({ count }: { count: number }) => count === 1 ? '1 session' : `${count} sessions`,
